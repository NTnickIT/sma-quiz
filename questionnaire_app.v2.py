...
archetype_indices = {
    "Nurturer":   [0,2,4,6, 32,34,36,38],   # Col 1 + Col 9
    "Maverick":   [1,3,5,7, 33,35,37,39],   # Col 2 + Col 10
    "Alchemist":  [8,10,12,14, 40,42,44,46], # Col 3 + Col 11
    "Celebrity":  [9,11,13,15, 41,43,45,47], # Col 4 + Col 12
    "Connector":  [16,18,20,22, 48,50,52,54],# Col 5 + Col 13
    "Accumulator":[17,19,21,23, 49,51,53,55],# Col 6 + Col 14
    "Romantic":   [24,26,28,30, 56,58,60,62],# Col 7 + Col 15
    "Ruler":      [25,27,29,31, 57,59,61,63] # Col 8 + Col 16
}
...
st.info("This is a recreated quiz based on the public Sacred Money Archetypes® format.")
